...
import type { VestPageData, SpecSection } from "./vestData";
import type { ShopSize } from "../shopData";

type VestPageClientProps = {
  data: VestPageData;
};

export default function VestPageClient({ data }: VestPageClientProps) {
      ...
      <div className="mx-auto max-w-[1440px] px-8 pb-10 pt-24 lg:px-[120px]">
        ...
        <div className="mb-20 flex flex-col gap-14 lg:flex-row">
          ...
          <div className="flex flex-col gap-6 lg:w-[574px]">
            ...
            <p className="hidden text-[16px] font-light leading-relaxed text-[#05365f] md:block">
        ...
        <div className="mb-20 hidden overflow-hidden rounded-[4px] border border-[#d0d0d0] md:block">
...
function FeatureGrid({ data }: { data: VestPageData }) {
  return (
...
function SizeGuideModal({ data, onClose }: { data: VestPageData; onClose: () => void }) {
  return (
        ...
        <div className="p-4 sm:p-8">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-[400px] w-full border-collapse">
              <thead>
                <tr>
                  {["SIZE", "LENGTH", "CHEST WIDTH", "SHOULDER WIDTH", "BOTTOM"].map((header) => (
                    <th
                      key={header}
